...
int main()
{
    ...
    while (getline(f, str))
    {
        ...
        pos_end = str.find(":");
        test_value = stoi(str.substr(0, pos_end));
        ...
        do 
        {
            ...
            {
                numbers.push_back(stoi(str.substr(pos_start, pos_end)));
                pos_start = pos_end+1;
            }
        }
        while ( pos_end!=string::npos );

        if (pos_start > 0)  numbers.push_back(stoi(str.substr(pos_start)));
